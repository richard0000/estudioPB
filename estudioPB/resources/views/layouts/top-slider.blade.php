        ...
        <div class="swiper-container top-baner">
          <div class="swiper-wrapper">
            <div class="swiper-slide active" data-val="0">
              <div class="bg">
                <img class="center_img onload" src="img/bg.jpg" data-width-img="1920" data-height-img="1080" onload="this.setAttribute('class', 'center_img onload loaded');"/>
              </div>
            ...
            <div class="swiper-slide" data-val="1">
              <div class="bg">
                <img class="center_img onload" src="img/hammer.jpg" data-width-img="1920" data-height-img="1080" onload="this.setAttribute('class', 'center_img onload loaded');"/>
              </div>
              <div class="slider-top-thumbs">
                <div class="row-fluid table">
                  <div class="col-lg-6 col-lg-offset-3 col-md-6 col-md-offset-3 col-sm-12 col-xs-12 t_td">
